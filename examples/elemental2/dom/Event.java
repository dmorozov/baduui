...
public class Event {
   ...
   @JsOverlay
   public static final double AT_TARGET = Event__Constants.AT_TARGET;
   @JsOverlay
   public static final double BUBBLING_PHASE = Event__Constants.BUBBLING_PHASE;
   @JsOverlay
   public static final double CAPTURING_PHASE = Event__Constants.CAPTURING_PHASE;
