...
public class JsArray<T> implements JsIterable<T>, JsArrayLike<T> {
   ...
   public static native <T, R> R[] from(JsArray.FromArrayLikeUnionType<T> arrayLike,
           JsArray.FromMapFn<? super T, ? extends R> mapFn, Object this_);
   ...
   @JsOverlay
   public static final <T, R> R[] from(String arrayLike, JsArray.FromMapFn<? super T, ? extends R> mapFn,
           Object this_) {
      return from(Js.<JsArray.FromArrayLikeUnionType<T>>uncheckedCast(arrayLike), mapFn, this_);
   }
   ...
   @JsOverlay
   public static final <T, R> R[] from(T[] arrayLike, JsArray.FromMapFn<? super T, ? extends R> mapFn, Object this_) {
   ...
   public native <R> R reduce(JsArray.ReduceCallbackFn<? extends R, ? super T> callback, Object initialValue);
