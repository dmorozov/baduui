...
import elemental2.dom.DOMConfiguration;
import elemental2.dom.FontFaceSet;
import jsinterop.base.JsPropertyMap;
import elemental2.dom.EntityReference;
...
public class Document extends Node {
    ...
    public native Touch createTouch(Window view, EventTarget target, int identifier, double pageX, double pageY,
    ...
    public native JsConstructorFn<? extends Element> registerElement(String type,
            Document.RegisterElementOptionsType options);
