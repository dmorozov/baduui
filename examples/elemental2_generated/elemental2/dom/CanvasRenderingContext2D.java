...
public native void clip(CanvasRenderingContext2D.ClipOptFillRuleOrPathUnionType optFillRuleOrPath,String optFillRule);
public native void clip(CanvasRenderingContext2D.ClipOptFillRuleOrPathUnionType optFillRuleOrPath);
@JsOverlay
public final void clip(Path2D optFillRuleOrPath,String optFillRule){
clip(Js.<CanvasRenderingContext2D.ClipOptFillRuleOrPathUnionType>uncheckedCast(optFillRuleOrPath),optFillRule);
}
@JsOverlay
public final void clip(Path2D optFillRuleOrPath){
clip(Js.<CanvasRenderingContext2D.ClipOptFillRuleOrPathUnionType>uncheckedCast(optFillRuleOrPath));
}
@JsOverlay
...
public native CanvasPattern createPattern(CanvasRenderingContext2D.CreatePatternImageUnionType image,String repetition);
@JsOverlay
public final CanvasPattern createPattern(HTMLCanvasElement image,String repetition){
return createPattern(Js.<CanvasRenderingContext2D.CreatePatternImageUnionType>uncheckedCast(image),repetition);
}
@JsOverlay
...
public native void drawImage(CanvasRenderingContext2D.DrawImageImageUnionType image,double dx,double dy,double dw,double dh,double sx,double sy,double sw,double sh);
public native void drawImage(CanvasRenderingContext2D.DrawImageImageUnionType image,double dx,double dy,double dw,double dh,double sx,double sy,double sw);
public native void drawImage(CanvasRenderingContext2D.DrawImageImageUnionType image,double dx,double dy,double dw,double dh,double sx,double sy);
public native void drawImage(CanvasRenderingContext2D.DrawImageImageUnionType image,double dx,double dy,double dw,double dh,double sx);
public native void drawImage(CanvasRenderingContext2D.DrawImageImageUnionType image,double dx,double dy,double dw,double dh);
public native void drawImage(CanvasRenderingContext2D.DrawImageImageUnionType image,double dx,double dy,double dw);
public native void drawImage(CanvasRenderingContext2D.DrawImageImageUnionType image,double dx,double dy);
@JsOverlay
...
drawImage(Js.<CanvasRenderingContext2D.DrawImageImageUnionType>uncheckedCast(image),dx,dy,dw,dh,sx,sy,sw,sh);
}
@JsOverlay
...
drawImage(Js.<CanvasRenderingContext2D.DrawImageImageUnionType>uncheckedCast(image),dx,dy,dw,dh,sx,sy,sw);
}
@JsOverlay
public final void drawImage(HTMLCanvasElement image,double dx,double dy,double dw,double dh,double sx,double sy){
drawImage(Js.<CanvasRenderingContext2D.DrawImageImageUnionType>uncheckedCast(image),dx,dy,dw,dh,sx,sy);
}
@JsOverlay
public final void drawImage(HTMLCanvasElement image,double dx,double dy,double dw,double dh,double sx){
drawImage(Js.<CanvasRenderingContext2D.DrawImageImageUnionType>uncheckedCast(image),dx,dy,dw,dh,sx);
}
@JsOverlay
public final void drawImage(HTMLCanvasElement image,double dx,double dy,double dw,double dh){
drawImage(Js.<CanvasRenderingContext2D.DrawImageImageUnionType>uncheckedCast(image),dx,dy,dw,dh);
}
@JsOverlay
public final void drawImage(HTMLCanvasElement image,double dx,double dy,double dw){
drawImage(Js.<CanvasRenderingContext2D.DrawImageImageUnionType>uncheckedCast(image),dx,dy,dw);
}
@JsOverlay
...
public native void fill(CanvasRenderingContext2D.FillOptFillRuleOrPathUnionType optFillRuleOrPath,String optFillRule);
public native void fill(CanvasRenderingContext2D.FillOptFillRuleOrPathUnionType optFillRuleOrPath);
@JsOverlay
public final void fill(Path2D optFillRuleOrPath,String optFillRule){
fill(Js.<CanvasRenderingContext2D.FillOptFillRuleOrPathUnionType>uncheckedCast(optFillRuleOrPath),optFillRule);
}
@JsOverlay
public final void fill(Path2D optFillRuleOrPath){
fill(Js.<CanvasRenderingContext2D.FillOptFillRuleOrPathUnionType>uncheckedCast(optFillRuleOrPath));
}
@JsOverlay
...
public native void setFillColor(CanvasRenderingContext2D.SetFillColorP0UnionType p0,double p1,double p2,double p3,double p4);
public native void setFillColor(CanvasRenderingContext2D.SetFillColorP0UnionType p0,double p1,double p2,double p3);
public native void setFillColor(CanvasRenderingContext2D.SetFillColorP0UnionType p0,double p1,double p2);
...
setFillColor(Js.<CanvasRenderingContext2D.SetFillColorP0UnionType>uncheckedCast(p0),p1,p2,p3,p4);
}
@JsOverlay
public final void setFillColor(String p0,double p1,double p2,double p3){
setFillColor(Js.<CanvasRenderingContext2D.SetFillColorP0UnionType>uncheckedCast(p0),p1,p2,p3);
}
@JsOverlay
...
public native void setStrokeColor(CanvasRenderingContext2D.SetStrokeColorP0UnionType p0,double p1,double p2,double p3,double p4);
public native void setStrokeColor(CanvasRenderingContext2D.SetStrokeColorP0UnionType p0,double p1,double p2,double p3);
public native void setStrokeColor(CanvasRenderingContext2D.SetStrokeColorP0UnionType p0,double p1,double p2);
public native void setStrokeColor(CanvasRenderingContext2D.SetStrokeColorP0UnionType p0,double p1);
...
setStrokeColor(Js.<CanvasRenderingContext2D.SetStrokeColorP0UnionType>uncheckedCast(p0),p1,p2,p3,p4);
}
@JsOverlay
public final void setStrokeColor(String p0,double p1,double p2,double p3){
setStrokeColor(Js.<CanvasRenderingContext2D.SetStrokeColorP0UnionType>uncheckedCast(p0),p1,p2,p3);
}
@JsOverlay
public final void setStrokeColor(String p0,double p1,double p2){
setStrokeColor(Js.<CanvasRenderingContext2D.SetStrokeColorP0UnionType>uncheckedCast(p0),p1,p2);
}
@JsOverlay
