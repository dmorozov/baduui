...
public class Geolocation {
    ...
    public native void getCurrentPosition(Geolocation.GetCurrentPositionSuccessCallbackFn successCallback,
            Geolocation.GetCurrentPositionErrorCallbackFn errorCallback, GeolocationPositionOptions options);
    ...
    public native int watchPosition(Geolocation.WatchPositionSuccessCallbackFn successCallback,
            Geolocation.WatchPositionErrorCallbackFn errorCallback, GeolocationPositionOptions options);
