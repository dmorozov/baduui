...
public class Range{
@JsOverlay
public static final double END_TO_END=Range__Constants.END_TO_END;
@JsOverlay
public static final double END_TO_START=Range__Constants.END_TO_START;
@JsOverlay
public static final double START_TO_END=Range__Constants.START_TO_END;
@JsOverlay
public static final double START_TO_START=Range__Constants.START_TO_START;
