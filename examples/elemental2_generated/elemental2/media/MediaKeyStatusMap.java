...
@JsFunction
public interface ForEachFn{
@JsType(isNative = true, name = "?", namespace = JsPackage.GLOBAL)
public interface P1UnionType{
@JsOverlay
static MediaKeyStatusMap.ForEachFn.P1UnionType of(Object o){
return Js.cast(o);
}
@JsOverlay
default ArrayBuffer asArrayBuffer(){
...
return onInvoke(p0,Js.<MediaKeyStatusMap.ForEachFn.P1UnionType>uncheckedCast(p1));
}
@JsOverlay
default Object onInvoke(String p0,ArrayBufferView p1){
return onInvoke(p0,Js.<MediaKeyStatusMap.ForEachFn.P1UnionType>uncheckedCast(p1));
}
Object onInvoke(String p0,MediaKeyStatusMap.ForEachFn.P1UnionType p1);
}
@JsType(isNative = true, name = "?", namespace = JsPackage.GLOBAL)
...
JsIterator<MediaKeyStatusMap.EntriesJsIteratorTypeParameterArrayUnionType[]> entries();
void forEach(MediaKeyStatusMap.ForEachFn fn);
@JsOverlay
...
JsIterator<MediaKeyStatusMap.KeysJsIteratorTypeParameterUnionType> keys();
