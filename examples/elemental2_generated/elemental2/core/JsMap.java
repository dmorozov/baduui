...
public class JsMap<KEY, VALUE> implements JsIterable<JsMap.JsIterableTypeParameterArrayUnionType<KEY, VALUE>[]>{
...
@JsOverlay
default JsMap.ConstructorIterableJsIterableTypeParameterArrayUnionType<KEY, VALUE>[][] asConstructorIterableArrayArrayUnionTypeArrayArray(){
return Js.cast(this);
}
@JsOverlay
default JsIterable<JsMap.ConstructorIterableJsIterableTypeParameterArrayUnionType<KEY, VALUE>[]> asJsIterable(){
return Js.cast(this);
}
@JsOverlay
...
public native JsIteratorIterable<JsMap.EntriesJsIteratorIterableTypeParameterArrayUnionType<KEY, VALUE>[]> entries();
public native Object forEach(JsMap.ForEachCallbackFn<? super KEY, ? super VALUE> callback,Object thisArg);
