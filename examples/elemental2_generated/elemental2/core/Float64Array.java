...
@JsOverlay
public static final <S>Float64Array from(Double[] source,Float64Array.FromMapFn mapFn,S this_){
...
public static native <S>Float64Array from(Float64Array.FromSourceUnionType source,Float64Array.FromMapFn mapFn,S this_);
...
@JsOverlay
public static final <S>Float64Array from(JsArrayLike<Double> source,Float64Array.FromMapFn mapFn,S this_){
return from(Js.<Float64Array.FromSourceUnionType>uncheckedCast(source),mapFn,this_);
}
@JsOverlay
...
@JsOverlay
public static final <S>Float64Array from(JsIterable<Double> source,Float64Array.FromMapFn mapFn,S this_){
return from(Js.<Float64Array.FromSourceUnionType>uncheckedCast(source),mapFn,this_);
}
@JsOverlay
...
@JsOverlay
public static final <S>Float64Array from(String source,Float64Array.FromMapFn mapFn,S this_){
return from(Js.<Float64Array.FromSourceUnionType>uncheckedCast(source),mapFn,this_);
}
@JsOverlay
