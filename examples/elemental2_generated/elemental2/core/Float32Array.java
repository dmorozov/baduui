...
@JsOverlay
public static final <S>Float32Array from(Double[] source,Float32Array.FromMapFn mapFn,S this_){
...
public static native <S>Float32Array from(Float32Array.FromSourceUnionType source,Float32Array.FromMapFn mapFn,S this_);
...
@JsOverlay
public static final <S>Float32Array from(JsArrayLike<Double> source,Float32Array.FromMapFn mapFn,S this_){
return from(Js.<Float32Array.FromSourceUnionType>uncheckedCast(source),mapFn,this_);
}
@JsOverlay
...
@JsOverlay
public static final <S>Float32Array from(JsIterable<Double> source,Float32Array.FromMapFn mapFn,S this_){
return from(Js.<Float32Array.FromSourceUnionType>uncheckedCast(source),mapFn,this_);
}
@JsOverlay
...
@JsOverlay
public static final <S>Float32Array from(String source,Float32Array.FromMapFn mapFn,S this_){
return from(Js.<Float32Array.FromSourceUnionType>uncheckedCast(source),mapFn,this_);
}
@JsOverlay
