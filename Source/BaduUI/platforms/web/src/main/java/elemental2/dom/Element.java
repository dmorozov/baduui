...
public class Element extends Node {
   ...
   public native void scrollIntoView(Element.ScrollIntoViewTopType scrollIntoViewOptions);

   public native void scrollTo(double x, double y);

   public native void scrollTo(Element.ScrollToScrollToOptionsOrXType options);
